## Premissas:
  ...
  Aplicação usando docker-compose (necessário instalar o docker-compose):
    No diretório do projeto rode o comando 'docker-compose build' e logo em seguida o comando 'docker-compose up' e irá rodar toda a aplicação.
